  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        ...
        const baseColor = "#8b8f9b";
        const hoverColor = item.color;
        const active = hoveredKey === key;
        const currentColor = active && hoverColor ? hoverColor : baseColor;
        ...
        return (
          <li
            ...
            >
            <div className="transition-colors duration-300" style={{ color: currentColor }}>
              {inner}
            </div>
          </li>
        );
      },
      [scaleOnHover, hoveredKey, pauseOnHover]
    );
